        ...
        <div className="flex flex-col w-full p-5 absolute bottom-0">
            <div className="flex justify-center items-center gap-4 mb-2 cursor-pointer">
                <a href="https://github.com/subinoybiswas/clippy" target='__blank'>
                    <Image src={Github} alt="GitHub Logo" width={25} height={25} className='opacity-70 hover:opacity-100' />
                </a>
                <Image src={AboutUs} alt="About Us Logo" width={25} height={25} className='opacity-70 hover:opacity-100' onClick={handleAbout} />
            </div>
